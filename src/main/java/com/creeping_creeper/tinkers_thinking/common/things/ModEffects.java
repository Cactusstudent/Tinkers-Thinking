...
import com.creeping_creeper.tinkers_thinking.common.things.effect.ModMobEffect;
...
public class ModEffects {
    ...
    public static final RegistryObject<MobEffect> sculk_power = MOB_EFFECTS.register("sculk_power",() -> new ModMobEffect(MobEffectCategory.BENEFICIAL, 0x009295));
