...
public class TinkersThinkingConfiguredFeatures {
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> Ardite_Ore = FeatureUtils.register("ardite_ore", Feature.ORE, new OreConfiguration(NETHER_Ardite_Ore, TinkersThinkingCommanConfigs.Ardite_Ore_Veins_Size.get()));
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> Chlorophyll_Ore = FeatureUtils.register("chlorophyll_ore", Feature.ORE, new OreConfiguration(OVERWORLD_Chlorophyll_Ore, TinkersThinkingCommanConfigs.Chlorophyll_Ore_Veins_Size.get()));
}
